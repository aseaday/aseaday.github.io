...
CUDA 的愿景在 Lindholm 等人 2008 年的白皮书中有详细阐述。我们强烈推荐这篇论文，它是 NVIDIA 文档中许多说法、图表，甚至特定措辞的原始来源。

在这里，我们主要关注 CUDA 的设备架构部分。"统一计算设备架构"的核心特征是相对于之前的 GPU 架构而言的简单性。
...
![A diagram of a fixed-pipeline device architecture (G71). Note the presence of a separate group of processors for handling fragment and vertex shading](/images/light-fixed-pipeline-g71.svg)
